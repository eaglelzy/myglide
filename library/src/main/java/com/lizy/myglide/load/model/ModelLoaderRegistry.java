...
public class ModelLoaderRegistry {
    ...
    public ModelLoaderRegistry(Context context, Pools.Pool<List<Exception>> exceptionListPool) {
        multiModelLoaderFactory = new MultiModelLoaderFactory(context, exceptionListPool);
    }
